...
2. [Why Software Dev Guidebook?](#Why%20Software%20Dev%20Guidebook?)
    ...
    2. [If it's not in Git it doesn't exist](#If%20it's%20not%20in%20Git%20it%20doesn't%20exist)
    ...
    3. [Adopt Semantic Versioning for tags and releases](#Adopt%20Semantic%20Versioning%20for%20tags%20and%20releases)
    4. [Review each other's code and be supportive](#Review%20each%20other's%20code%20and%20be%20supportive)
    5. [If the critical path has not been reviewed… it shouldn't go onto master branch](#If%20the%20critical%20path%20has%20not%20been%20reviewed%E2%80%A6%20it%20shouldn't%20go%20onto%20master%20branch)
    6. [Continuous Integration - If it doesn't have tests… it doesn't work](#Continuous%20Integration%20-%20If%20it%20doesn't%20have%20tests%E2%80%A6%20it%20doesn't%20work)
    7. [Continuous Delivery](#Continuous%20Delivery)
    8. [Continuous Deployment](#Continuous%20Deployment)
    9. [If it Doesn't have Documentation… It's Not Usable](#If%20it%20Doesn't%20have%20Documentation%E2%80%A6%20It's%20Not%20Usable)
    10. [Learning mindset](#Learning%20mindset)
    11. [Customers’ Bill of Rights (modified from Uncle Bob Martin’s ‘Clean Agile’)](#Customers%E2%80%99%20Bill%20of%20Rights%20(modified%20from%20Uncle%20Bob%20Martin%E2%80%99s%20%E2%80%98Clean%20Agile%E2%80%99))
    12. [Developers’ Bill of Rights (modified from Uncle Bob Martin’s ‘Clean Agile’)](#Developers%E2%80%99%20Bill%20of%20Rights%20(modified%20from%20Uncle%20Bob%20Martin%E2%80%99s%20%E2%80%98Clean%20Agile%E2%80%99))
    13. [Tooling](#Tooling)
        1. [Don’t be Smart - Use the Right Tools for the Job and for your customer](#Don%E2%80%99t%20be%20Smart%20-%20Use%20the%20Right%20Tools%20for%20the%20Job%20and%20for%20your%20customer)
        2. [To Garbage Collect (GC) or Not To GC](#To%20Garbage%20Collect%20(GC)%20or%20Not%20To%20GC)
        3. [Kanban, Jira & Confluence](#Kanban,%20Jira%20&%20Confluence)
        4. [Gitlab / Version Control](#Gitlab%20/%20Version%20Control)
        5. [Container Repository](#Container%20Repository)
        6. [Build Tools](#Build%20Tools)
        7. [Static Code Analysis / Linting / CheckStyle / FindBugs / SonarCube / IDE checks](#Static%20Code%20Analysis%20/%20Linting%20/%20CheckStyle%20/%20FindBugs%20/%20SonarCube%20/%20IDE%20checks)
        8. [Containerisation for Portability](#Containerisation%20for%20Portability)
        9. [Workflows & Containerisation](#Workflows%20&%20Containerisation)
3. [Development Guide / Best Practices](#Development%20Guide%20/%20Best%20Practices)
    1. [Quality is the best shortcut (Fowler’s Design Stamina Hypothesis)](#Quality%20is%20the%20best%20shortcut%20(Fowler%E2%80%99s%20Design%20Stamina%20Hypothesis))
    2. [Naming with Meaningful & Descriptive Names](#Naming%20with%20Meaningful%20&%20Descriptive%20Names)
    3. [Testing has Three Main Purposes](#Testing%20has%20Three%20Main%20Purposes)
    4. [Keep Classes & Functions Small(ish)](#Keep%20Classes%20&%20Functions%20Small(ish))
    5. [Limit the Number of Function Arguments](#Limit%20the%20Number%20of%20Function%20Arguments)
    6. [Functions should do one thing, and do it well](#Functions%20should%20do%20one%20thing,%20and%20do%20it%20well)
    7. [Classes / Code Should be Cohesive](#Classes%20/%20Code%20Should%20be%20Cohesive)
    8. [Classes should have only one reason to change / do one thing and do it well](#Classes%20should%20have%20only%20one%20reason%20to%20change%20/%20do%20one%20thing%20and%20do%20it%20well)
    9. [If using OOP, know SOLID](#If%20using%20OOP,%20know%20SOLID)
    10. [Dependency Inversion Principle](#Dependency%20Inversion%20Principle)
    11. [Dependency Injection (DI) & Inversion of Control (IoC)](#Dependency%20Injection%20(DI)%20&%20Inversion%20of%20Control%20(IoC))
    12. [Avoid Inheritance Tax - Prefer Object Composition, Interfaces, Traits, Mixins to achieve ‘Ad-hoc Polymorphism’](#Avoid%20Inheritance%20Tax%20-%20Prefer%20Object%20Composition,%20Interfaces,%20Traits,%20Mixins%20to%20achieve%20%E2%80%98Ad-hoc%20Polymorphism%E2%80%99)
    13. [It Should Not be Possible to Create an Object in an Invalid State](#It%20Should%20Not%20be%20Possible%20to%20Create%20an%20Object%20in%20an%20Invalid%20State)
    14. [Know Some Design Patterns](#Know%20Some%20Design%20Patterns)
        1. [The Strategy Pattern Example](#The%20Strategy%20Pattern%20Example)
        2. [The Visitor Pattern](#The%20Visitor%20Pattern)
    15. [Consider using the Builder Pattern for More Complex Object Creation Scenarios](#Consider%20using%20the%20Builder%20Pattern%20for%20More%20Complex%20Object%20Creation%20Scenarios)
    16. [Information Hiding](#Information%20Hiding)
    17. [DRY – Don’t Repeat Yourself](#DRY%20%E2%80%93%20Don%E2%80%99t%20Repeat%20Yourself)
    18. [YAGNI – You Aren’t Going to Need It](#YAGNI%20%E2%80%93%20You%20Aren%E2%80%99t%20Going%20to%20Need%20It)
    19. [Comment ‘in-line’ As You Go](#Comment%20%E2%80%98in-line%E2%80%99%20As%20You%20Go)
    20. [The Boy Scout Rule](#The%20Boy%20Scout%20Rule)
    21. [Law of Demiter & Train Wrecks](#Law%20of%20Demiter%20&%20Train%20Wrecks)
    22. [Functional vs OOP? Choose Two](#Functional%20vs%20OOP?%20Choose%20Two)
    23. [Don’t pollute Functional Code with Mutable State](#Don%E2%80%99t%20pollute%20Functional%20Code%20with%20Mutable%20State)
    24. [Make Immutability your Default](#Make%20Immutability%20your%20Default)
    25. [Interior Mutability](#Interior%20Mutability)
    26. [Use Calculations Where Possible to Limit Side Effects](#Use%20Calculations%20Where%20Possible%20to%20Limit%20Side%20Effects)
    27. [Separate Operations from Calculations](#Separate%20Operations%20from%20Calculations)
    28. [Error Handling - 4 Types of Problems](#Error%20Handling%20-%204%20Types%20of%20Problems)
    29. [Error Handling - Exceptions vs Errors-as-Values ?](#Error%20Handling%20-%20Exceptions%20vs%20Errors-as-Values%20?)
    30. [Error Handling - Exceptions should not be used for flow control, use errors-as-values instead (exceptional != conditional)](#Error%20Handling%20-%20Exceptions%20should%20not%20be%20used%20for%20flow%20control,%20use%20errors-as-values%20instead%20(exceptional%20!=%20conditional))
    31. [Error Handling - Only use exceptions for exceptional situations such as coding errors and unexpected situations (exceptional != conditional)](#Error%20Handling%20-%20Only%20use%20exceptions%20for%20exceptional%20situations%20such%20as%20coding%20errors%20and%20unexpected%20situations%20(exceptional%20!=%20conditional))
    32. [Error Handling - Provide Relevant Exceptions for the abstraction layer](#Error%20Handling%20-%20Provide%20Relevant%20Exceptions%20for%20the%20abstraction%20layer)
    33. [Error Handling - Bubble Exceptions Upwards or Trap at Source?](#Error%20Handling%20-%20Bubble%20Exceptions%20Upwards%20or%20Trap%20at%20Source?)
    34. [Error Handling – Model the Absence of Value Explicitly](#Error%20Handling%20%E2%80%93%20Model%20the%20Absence%20of%20Value%20Explicitly)
    35. [Error Handling in Functional Programming – Error Monads such as ‘Either’ & ‘Validated’](#Error%20Handling%20in%20Functional%20Programming%20%E2%80%93%20Error%20Monads%20such%20as%20%E2%80%98Either%E2%80%99%20&%20%E2%80%98Validated%E2%80%99)
    36. [Data Orientated Programming with Algebraic Data Types (ADTs)](#Data%20Orientated%20Programming%20with%20Algebraic%20Data%20Types%20(ADTs))
    37. [Concurrency & Parallelism](#Concurrency%20&%20Parallelism)
        1. [Know the difference between IO bound tasks and CPU bound tasks and their common solution patterns](#Know%20the%20difference%20between%20IO%20bound%20tasks%20and%20CPU%20bound%20tasks%20and%20their%20common%20solution%20patterns)
    38. [Security Development Practices](#Security%20Development%20Practices)
4. [Agile Process Guide a.k.a ‘Feedback Driven Development’](#Agile%20Process%20Guide%20a.k.a%20%E2%80%98Feedback%20Driven%20Development%E2%80%99)
    1. [Design Thinking Workshops & Scoping Document](#Design%20Thinking%20Workshops%20&%20Scoping%20Document)
    2. [Epics / Work Package Span Multiple Sprints](#Epics%20/%20Work%20Package%20Span%20Multiple%20Sprints)
    ...
    4. [Arrange core user stories into a Journey Map with a narrative flow or backbone of ‘Big Activities’ moving from left to right](#Arrange%20core%20user%20stories%20into%20a%20Journey%20Map%20with%20a%20narrative%20flow%20or%20backbone%20of%20%E2%80%98Big%20Activities%E2%80%99%20moving%20from%20left%20to%20right)
    5. [Task Backlog](#Task%20Backlog)
    6. [Requirements Document & System Architecture Document](#Requirements%20Document%20&%20System%20Architecture%20Document)
    7. [1-to-2-week Sprints](#1-to-2-week%20Sprints)
    8. [Inline Testing](#Inline%20Testing)
    9. [Demo & Playbacks](#Demo%20&%20Playbacks)
    10. [Acceptance, Sign Off & Cucumbers](#Acceptance,%20Sign%20Off%20&%20Cucumbers)
    11. [Iteration & Incrementalism](#Iteration%20&%20Incrementalism)
    12. [Cup Cake Roadmaps](#Cup%20Cake%20Roadmaps)
5. [Appendix - Recommended Texts](#Appendix%20-%20Recommended%20Texts)
